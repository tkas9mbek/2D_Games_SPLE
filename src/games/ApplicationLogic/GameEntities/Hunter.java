...
public class Hunter extends AbstractHero {
    ...
    private final String avatar_left = PROJECT_DIR + "ApplicationLogic\\GameEntities\\images\\hunter_left.png";
    private final String avatar_right = PROJECT_DIR + "ApplicationLogic\\GameEntities\\images\\hunter_right.png";
    private final String SETTINGS = PROJECT_DIR + "Settings.txt";
    private Health health;
    private boolean toLeft = true;
    private final HunterSkillBuilder skills;
