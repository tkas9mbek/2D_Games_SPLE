...
public class SoundEngine {
    ...
    private final String DIR_LOC = "file:/" + System.getProperty("user.dir").replace("\\", "/") +
            "/game-assets/ApplicationLogic/GameManagement/Sounds/";
    ...
    AudioClip collusion =  new AudioClip(DIR_LOC + "collusion.wav");
    AudioClip bulletFire =  new AudioClip(DIR_LOC + "bulletFire.wav");
    AudioClip bulletHit =  new AudioClip(DIR_LOC + "bulletHit.wav");
    AudioClip skillUsed =  new AudioClip(DIR_LOC + "skillUsed.wav");
    AudioClip powerUp =  new AudioClip(DIR_LOC + "powerUp.wav");
    AudioClip destroyed =  new AudioClip(DIR_LOC + "destroyed.wav");

    //Media player holds music
    Media song1 = new Media(DIR_LOC + "20.wav");
    MediaPlayer music1 = new MediaPlayer(song1);
    Media song2 = new Media(DIR_LOC + "21.wav");
